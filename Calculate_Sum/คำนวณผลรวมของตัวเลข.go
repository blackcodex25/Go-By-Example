...
คำนวณผลรวมของผลคูณเหล่านั้นโดยใช้ช่องทางเพื่อส่งค่าระหว่าง goroutine
พิมพ์ผลรวมของค่าที่คำนวณได้
หลักการนี้ช่วยเพิ่มความเร็วในการประมวลผลด้วยการใช้ concurrent programming
*/
/* 1.การสร้างช่องทาง (channel) สำหรับเก็บผลคูณของ 3 และ 5
...
ถ้าใช่ ก็จะส่งค่าผลคูณนั้นเข้าไปในช่องทาง work ผ่านคำสั่ง work <- i
เมื่อวนครบจะทำการปิดช่องทาง work ด้วย close(work) เพื่อบอกว่าการส่งข้อมูลเสร็จสมบูรณ์
