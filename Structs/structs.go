...
*/
// ประกาศ struct ชื่อ person ที่มีฟิลด์ คือ name
// ชนิดข้อมูล string และ age ชนิดข้อมูล int
...
func main() {
	...
	// สร้าง person ที่มีชื่อ Fred แต่ไม่ระบุ age ดังนั้น age จะถูกตั้งค่าเป็รค่าเริ่มต้น
	// (zero value) คือ 0
	f.Println(person{name: "Fred"})

	// &person{name: "Ann", age: 40} สร้าง pointer ไป
	// ยัง person ที่มีชื่อ Ann และอายุ 40
